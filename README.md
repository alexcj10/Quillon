...
🔗 **[Live Demo](https://quillon.netlify.app/)** | 🌟 **[Star on GitHub](https://github.com/alexcjosh/Quillon)**  
<p align="center">
...
```bash
git clone https://github.com/alexcjosh/Quillon.git
```
...
📜 See detailed contribution guidelines in the **[CONTRIBUTING.md](https://github.com/alexcjosh/Quillon/blob/main/CONTRIBUTING.md)** file.

---

## 🐝 License  

This project is licensed under the **Quillon Exclusive License**. See **[LICENSE](https://github.com/alexcjosh/Quillon/blob/main/Quillon%20Exclusive%20License)** for details.
